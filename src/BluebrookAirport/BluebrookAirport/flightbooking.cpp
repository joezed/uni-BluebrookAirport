...
int main() {
	...
	while (finished == false) {
		...
		//----------------------------------------------------------------------------------------------------------------------------
			...
			cin >> email;
			bool found_at = email.find("@") != string::npos;
			bool found_fullstop = email.find(".") != string::npos;

			while (userAccount.searchXML("email", email) == true) {
				cout << "\nINVALID EMAIL - ALREADY IN USE";
				cout << "\nPlease enter your email address: ";
				cin >> email;
				found_at = email.find("@") != string::npos;
				found_fullstop = email.find(".") != string::npos;
			}
